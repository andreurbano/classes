...
begin
  ...
  Edit9.Text     := 'SERVIÇOS PRO-CONDOMINO MARINGA S/C LTDA'; //Cedente
  Edit1.Text     := '0718'; //Agência
  Edit2.Text     := '29'; //Digito da agência não informado
  Edit5.Text     := '51663'; //Código Cedente
  Edit6.Text     := ''; //Digito do código do cedente
  Edit3.Text     := '1000'; //Número do documento do cedente
  Edit7.Text     := '3'; //Carteira
  Edit8.Text     := ''; //Convênio, utilizado apenas para o banco do brasil
