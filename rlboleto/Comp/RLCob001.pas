...
begin
   ...
   if StrToInt(ADigitoNossoNumero) = 0 then
...
//      Registro := Registro + Formatar(Titulos[NumeroRegistro].Cedente.CodigoCedente,18,false,'0')  + '  '; //33 a 52 - Código do convênio no banco
      Registro := Registro + Formatar(Titulos[NumeroRegistro].Cedente.ContaBancaria.Convenio + '0014' + Titulos[NumeroRegistro].Carteira ,18,false,'0')  + '  '; //33 a 52 - Código do convênio no banco
...
//      Registro := Registro + Formatar(Titulos[NumeroRegistro].Cedente.CodigoCedente,18,false,'0')  + '  '; //33 a 52 - Código do convênio no banco
      ...
      begin
         ...
         Registro := Registro + Formatar(Titulos[NumeroRegistro].NossoNumero,17,True,'0') + '   '; //38 a 57 - Nosso número - identificação do título no banco
         ...
         begin
            ...
            begin
               ...
               begin
                  ...
                  sDataCredito := Copy(Retorno.Strings[NumeroRegistro],146,2) + '/' +
                                  Copy(Retorno.Strings[NumeroRegistro],148,2) + '/' +
                                  Copy(Retorno.Strings[NumeroRegistro],150,4) ;

                  if ( sDataCredito <> '00/00/0000' ) then
                  begin
                    DataCredito := StrToDate( sDataCredito );
                  end;
