...
TfrmPesquisaWizard = class(TForm)
 mmFilter: TMemo;
 gbField:  TGroupBox;
...
var
  frmPesquisaWizard: TfrmPesquisaWizard;
...
{ Get dataset value }
function TfrmPesquisaWizard.GetDataSet: TDataSet;
begin
...
{ On form show event }
procedure TfrmPesquisaWizard.FormShow(Sender: TObject);
var
  I: Integer;
begin
...
{ Set a filter }
function TfrmPesquisaWizard.Execute: Boolean;
begin
...
procedure TfrmPesquisaWizard.btnFilterClick(Sender: TObject);
var
  EnterStr: string;
begin
...
{ On field click }
procedure TfrmPesquisaWizard.lsbFieldsDblClick(Sender: TObject);
var
  EnterStr: string;
begin
...
function TfrmPesquisaWizard.GetFilter: string;
begin
  Result := mmFilter.Lines.Text;
end;

{ On set filter button click }
procedure TfrmPesquisaWizard.btnSetFilterClick(Sender: TObject);
begin
...
procedure TfrmPesquisaWizard.btnDelFilterClick(Sender: TObject);
begin
...
{ On key down event }
procedure TfrmPesquisaWizard.FormKeyDown(Sender: TObject; var Key: Word; Shift: TShiftState);
begin
...
procedure TfrmPesquisaWizard.btnDiferenteClick(Sender: TObject);
begin
 mmFilter.Text := mmFilter.Text + btnDiferente.Caption;
end;

procedure TfrmPesquisaWizard.btnAndClick(Sender: TObject);
begin
 mmFilter.Text := mmFilter.Text + btnAnd.Caption;
end;

procedure TfrmPesquisaWizard.btnNotClick(Sender: TObject);
begin
 mmFilter.Text := mmFilter.Text + btnNot.Caption;
end;

procedure TfrmPesquisaWizard.btnOrClick(Sender: TObject);
begin
 mmFilter.Text := mmFilter.Text + btnOr.Caption;
end;

procedure TfrmPesquisaWizard.btnXorClick(Sender: TObject);
begin
 mmFilter.Text := mmFilter.Text + btnXor.Caption;
end;

procedure TfrmPesquisaWizard.btnIgualClick(Sender: TObject);
begin
 mmFilter.Text := mmFilter.Text + btnIgual.Caption;
end;

procedure TfrmPesquisaWizard.btnMenorClick(Sender: TObject);
begin
 mmFilter.Text := mmFilter.Text + btnMenor.Caption;
end;

procedure TfrmPesquisaWizard.btnMaiorClick(Sender: TObject);
begin
 mmFilter.Text := mmFilter.Text + btnMaior.Caption;
end;

procedure TfrmPesquisaWizard.btnMenorIgualClick(Sender: TObject);
begin
 mmFilter.Text := mmFilter.Text + btnMenorIgual.Caption;
end;

procedure TfrmPesquisaWizard.btnMaiorIgualClick(Sender: TObject);
begin
 mmFilter.Text := mmFilter.Text + btnMaiorIgual.Caption;
end;

procedure TfrmPesquisaWizard.btnSomaClick(Sender: TObject);
begin
// mmFilter.Text := mmFilter.Text + btnSoma.Caption;
end;

procedure TfrmPesquisaWizard.btnSubtraiClick(Sender: TObject);
begin
// mmFilter.Text := mmFilter.Text + btnSubtrai.Caption;
end;

procedure TfrmPesquisaWizard.btnDivideClick(Sender: TObject);
begin
// mmFilter.Text := mmFilter.Text + btnDivide.Caption;
end;

procedure TfrmPesquisaWizard.btnMultiplicaClick(Sender: TObject);
begin
// mmFilter.Text := mmFilter.Text + btnMultiplica.Caption;
end;

procedure TfrmPesquisaWizard.btnPotenciaClick(Sender: TObject);
begin
// mmFilter.Text := mmFilter.Text + btnPotencia.Caption;
end;

procedure TfrmPesquisaWizard.btnPercentualClick(Sender: TObject);
begin
// mmFilter.Text := mmFilter.Text + btnPercentual.Caption;
end;

procedure TfrmPesquisaWizard.btnParentEsquerdoClick(Sender: TObject);
begin
 mmFilter.Text := mmFilter.Text + btnParentEsquerdo.Caption;
end;

procedure TfrmPesquisaWizard.btnParentDireitoClick(Sender: TObject);
begin
 mmFilter.Text := mmFilter.Text + btnParentDireito.Caption;
end;

procedure TfrmPesquisaWizard.btnSetarFiltroClick(Sender: TObject);
var
 sLinha:        string;
 sCampoNome:    string;
 sCondicao:     string;
